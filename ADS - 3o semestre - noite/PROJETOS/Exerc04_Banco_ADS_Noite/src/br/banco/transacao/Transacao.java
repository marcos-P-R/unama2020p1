...
public class Transacao {
    ...
    //////////// R: Não, porque ela está programada para funcionar tanto para boletos,
    // quanto para transferência e isso é prejudicial para o projeto, já que gera
    // confusão na hora da criação de objetos dessa classe.
