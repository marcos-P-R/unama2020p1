    ...
    public JanelaLogin() {
        ...
        botaoOK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                ////////// R: O erro ocorre, porque o método getPassword está 
                // retornando um valor do tipo char[] e estamos tentando
                // armazenar esse valor em uma variável do tipo String, gerando
                ...
                if ( senhaDigitada.equals("senha!@#") && 
                    ...
                    JOptionPane.showMessageDialog(null, "Senha Correta", "Sistema.com", 
                            JOptionPane.INFORMATION_MESSAGE);
                } else {
                    // senão, mostre a seguinte caixa:
                    JOptionPane.showMessageDialog(null, "Senha Incorreta", "Sistema.com", 
